...
class _ProductCategoryViewState extends State<ProductCategoryView> {
  ...
  Future<List<QueryDocumentSnapshot>> _getProductCategories() async {
    QuerySnapshot snapshot = await db.collection('productcategoryreg').get();
      ...
      body: FutureBuilder<List<QueryDocumentSnapshot>>(
        ...
        builder: (context, snapshot){
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(
                child: Text("No product category found.",
          ...
          final categories = docs
              .map((doc) => Productcategorymodel.fromJson(
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => ProductCategoryReg(category: category),
                                  ),
                              ...
                              onTap: () async {
                                final confirm = await showDialog<bool>(
                                  ...
                                  builder: (_) => AlertDialog(
                                    ...
                                    content: Text("Delete ${category.productname}?"),
                                    actions: [
                                      TextButton(
                                ...
                                if (confirm == true) {
                                  ...
                                  await datafeed.deleteCategory(category.id);
